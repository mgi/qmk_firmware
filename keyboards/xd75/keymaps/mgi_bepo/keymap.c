...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BP] = {{ BP_DOLLAR, BP_DQOT, BP_LGIL, BP_RGIL, BP_LPRN, BP_RPRN, KC_TRNS, BP_AT, BP_PLUS , BP_MINUS, BP_SLASH, BP_ASTR, BP_EQUAL, BP_PERCENT, KC_VOLU },
		 ...
		 { MO(_FN), KC_TRNS, KC_TRNS, BP_ALGR, KC_LALT, KC_LCTL, KC_SPC, KC_RCTL, KC_LALT, BP_ALGR, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_MPRV }},
	[_FN] = {{ RESET, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_SLSH, KC_ASTR, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS },
